          ...
          <div key={card.id} className="charCard g-0">
            ...
            <div className="charInfoCard">
              <div className="charSpecText">
                <span style={{ color: "lightgray" }}>Species:&nbsp;</span>
                <span style={{ color: speciesColor }}>{speciesString}</span>
              </div>
              ...
              <div className="charOrigText">
                <span style={{ color: "lightgray" }}>Origin:&nbsp;</span>
                <span style={{ color: originColor }}>{originString}</span>
              </div>
              <div className="charLocaText">
                <span style={{ color: "lightgray" }}>Location:&nbsp;</span>
                <span style={{ color: locationColor }}>{locationString}</span>
              </div>
            </div>
            <div>
              <h1 className="charCardName">{card.name}</h1>
            </div>
          </div>
        );
      })}
