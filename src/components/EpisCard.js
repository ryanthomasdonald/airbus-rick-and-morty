  ...
  return (
    <div className="row justify-content-center g-0">
      {cards.map((card) => {
        ...
        if (
          card.air_date === "unknown" ||
          null ||
          "" ||
          undefined ||
          card.air_date.length === 0
        ) {
          airDateColor = "orange";
          ...
          <div key={card.id} className="episCard row g-0">
            <div className="episInfoCard">
              <div className="charSpecText">
                ...
                <span style={{ color: airDateColor }}>{airDateString}</span>
              </div>
              <div className="charStatText">
                <span style={{ color: "lightgray" }}>Episode:&nbsp;</span>
                <span style={{ color: episodeColor }}>{episodeString}</span>
              </div>
              <div className="charStatText">
                <span style={{ color: "lightgray" }}>
                  Number of Characters:&nbsp;
                </span>
                <span style={{ color: "white" }}>{card.characters.length}</span>
              </div>
            </div>
            <div>
