  ...
  return (
    <div>
      ...
      <div className="text-center">
        <button
          type="button"
          className="btn topNavButton btn-lg"
          onClick={(e) => pageDown(e)}
        >
          PREV
        </button>
        <button
      ...
      {/* cards */}
      <div>{isCharacters ? <CharCard data={apiResArr} /> : null}</div>
      <div>{isLocations ? <LocaCard data={apiResArr} /> : null}</div>
      <div>{isEpisodes ? <EpisCard data={apiResArr} /> : null}</div>

      {/* bottom prev/next */}
      <div className="text-center">
        <button
          type="button"
          className="btn bottomNavButton btn-lg"
          onClick={(e) => pageDown(e)}
        >
          PREV
        </button>
